   ...
   <table cellspacing="0" cellpadding="0" border="0px" align="center"
      ...
      <tr>
        <td style="text-align: center;">
            ...
            <p style="font-size:22px; color:#241f20; letter-spacing:0.5px; margin-top:15px;margin-bottom:20px;">Confirm<br>
                your account and Create Your password by <br>
            clicking below.</p>
            <a href="{{ route('confirm.token', ['token' => $token ]) }}" target="_blank" style="    color: #fff; text-decoration: none;font-size: 20px;background: #000;padding: 8px 20px;">Confirm Account
            </a>
            <br>
            <br>
            <br>
