...
@section('content')
	<tr>
		<td style="text-align: center;">
			...
			<p style="font-size:22px; color:#241f20; letter-spacing:0.5px; margin-top:15px;margin-bottom:20px;">Your application for {{$data['job_name']}} has been rejected by {{$data['agency']}}. Keep a track of your other jobs and discover more on your Tradehook profile.   </p>
