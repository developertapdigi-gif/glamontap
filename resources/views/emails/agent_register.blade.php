...
@section('content')
	<tr>
		<td style="text-align: center;">
			...
			<p style="font-size:22px; color:#241f20; letter-spacing:0.5px; margin-top:15px;margin-bottom:20px;">Welcome to {{$data['agency']}}</p>
			...
			<p style="font-size:22px; color:#241f20; letter-spacing:0.5px; margin-top:15px;margin-bottom:20px;">Once you've set your password, you'll be able to access your account and enjoy all the benefits of being a {{$data['agency']}} member.</p>
