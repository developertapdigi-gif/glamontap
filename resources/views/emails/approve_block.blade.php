...
@section('content')
	<tr>
		<td style="text-align: center;">
			...
			<p style="font-size:22px; color:#241f20; letter-spacing:0.5px; margin-top:15px;margin-bottom:20px;">This email is to inform you that your account {{$data['agency']}} has been successfully {{$data['text']}}. </p>
