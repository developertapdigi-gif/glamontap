               ...
               <div class="card-body text-list">
                  <div class="form-group col-md-12 search-bar">
                     ...
                     <input name="name" id="name"
                        class="form-control @error('name') is-invalid @enderror" type="text" value="{{ old('name') }}" >
                     @error('name')
                                ...
                                $this_str = '<div class="col-md-6 job-list">
                                    ...
                                    <div class="card-header bg-default job-header">
                                        <div class="custom-control custom-control-alternative custom-checkbox job-text">';
                                            ...
                                            $this_str .= '<label class="'.( !$hide_maincheck ? 'custom-control-label ' : '' ).'" for="prev_'.$group_name.'_manage">'.$group_heading.'</label>
                                        </div>
                                    </div>
                                    <div class="card-body text-list">
                                        <div class="row">';
                  ...
                  <div class="button-bottom float-right">
