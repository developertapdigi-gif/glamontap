...
<div class="col-12">
    ...
    <div class="page-title">
                    <h2 class="desktop-content"><i class="employees-icon"></i>Sub Users</h2>
                    
                    <h2 class="mobile-content"><i class="employees-icon"></i>Sub Users</h2>
                    <div class="right-title  me-0">
                    <a href="{{ route('agent.create') }}" class="text-white">
                        <button class="primary-btn blue-button"><i class="icon-plus"></i>New Sub User</button>
                    </a>
                    </div>
                </div>
