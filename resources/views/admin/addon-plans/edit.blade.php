...
<div class="container-fluid middle-content dashboard-content">
    ...
    <div class="skill-reg-form">
        <form id="createform" class="regular-form" action="{{ route('addon-plans.update',$model->id) }}" method="POST"  enctype="multipart/form-data">
          @csrf
          @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <input id="name" name="name" class="form-control @error('name') is-invalid @enderror" type="text" value="{{ $model->name }}">
                    </div>
                    @error('name')
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <input id="price" name="price" min="0" class="form-control @error('price') is-invalid @enderror" type="number" value="{{ $model->price }}">
                    </div>
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
