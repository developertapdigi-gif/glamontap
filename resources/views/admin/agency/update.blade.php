...
<div class="container-fluid middle-content dashboard-content">
        <div class="page-title">
            <h2 class="desktop-content"><i class="agency-black"></i>Update Company</h2>
    
            <h2 class="mobile-content"><i class="agency-black"></i>Update Company</h2>
      ...
      <div class="skill-reg-form">
          <form id="createform" class="regular-form" action="{{ route('agency.update',$model->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
                        ...
                        <div class="row">  
                          <div class="col-md-12">        
                            <label>Upload Logo</label>                         
                                    ...
                                    <div class="fallback">                            
                                        <input type="hidden" name="logo" id="filenames" value="{{$model->logo}}" />
                                    </div>
                            </div>
                        </div>
...
let mockFile = { name: "{{$model->logo}}",size:100};
if(mockFile.name){
    $('#upload-label').css('visibility', 'hidden');
    dropzone.displayExistingFile(mockFile,"{{asset($model->logo)}}");  
}
