...
<div class="container-fluid middle-content dashboard-content">
      ...
      <div class="skill-reg-form">
        <form id="createform" class="regular-form" action="{{ route('trader.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="row">
                            <div class="col-md-12">
                                ...
                                <fieldset class="upload_dropZone text-center mb-3 p-4">
                                    ...
                                    <input id="upload_image_background" type="file" class="@error('profile_picture') is-invalid @enderror position-absolute invisible " name="profile_picture" accept="image/*">
            ...
            <div class="row mt-3">
              <div class="col-6">
                ...
                <div class="input-group">
                    ...
                    <select name="skill_category_id" class="form-control form-select" aria-label="Default select example">
                        <option value="">Select Skill Category</option>
                        @foreach ($skill_categories as $skillcategory)
                            <option value="{{ $skillcategory->id}}" {{ (old('skill_category_id'))?'selected':''}}>{{ $skillcategory->name }}</option>
                        @endforeach
                ...
                <div class="input-group">
                  ...
                  <select name="badge_id" class="form-control form-select" aria-label="Default select example">
                      ...
                      @foreach ($badges as $badge)
                          <option value="{{ $badge->id}}" {{ (old('badge_id'))?'selected':''}}>{{ $badge->name }}</option>
                      @endforeach
