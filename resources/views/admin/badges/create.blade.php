...
<div class="container-fluid middle-content dashboard-content">
        <div class="page-title">
            <h2 class="desktop-content"><i class="badge-black"></i>Add Badge</h2>
      ...
      <div class="skill-reg-form">
        <form id="createform" class="regular-form" action="{{ route('badges.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            <div class="row">
              <div class="col">
            ...
            <div class="row ">
              <div class="col-6">
                ...
                <div class="row">
                  <div class="col-6">
                  <input id="minimum_range" name="minimum_range" min="0" class="form-control @error('minimum_range') is-invalid @enderror" type="number" value="{{ old('minimum_range') }}">
                  </div>
                  <div class="col-6">                   
                  <input id="maximum_range" name="maximum_range" min="0" class="form-control @error('maximum_range') is-invalid @enderror" type="number" value="{{ old('maximum_range') }}">
                  </div> 
                </div>                
              </div>
            ...
            <div class="row">
            <div class="mt-5">
              <button class="btn btn-primary" type="submit">Add New Badge</button>
