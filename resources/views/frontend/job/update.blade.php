...
<div class="container-fluid middle-content dashboard-content">
    <div class="page-title">
        <h2 class="desktop-content"><i class="newjob-black"></i>Update Post Job</h2>

        <h2 class="mobile-content"><i class="newjob-black"></i>Update Post Job</h2>
          ...
          <div class="row mt-3">
                ...
                <div class="input-group">
                    <select name="skill_category" id="skill_category" class="form-control form-select @error('skill_category') is-invalid @enderror" aria-label="skill_category">
                        ...
                        @foreach ($categories as $_cat)
                            <option value="{{ $_cat->id}}" @if($_cat->id == $model->skill_category) {{ 'selected' }} @endif>{{ $_cat->name }}</option>
                        @endforeach
                ...
                <div class="input-group">
                    <select name="experiance_range" class="form-control form-select @error('experiance_range') is-invalid @enderror" aria-label="agency_id" id="agency_id">
                        @foreach ($experience_range as $key=>$experiance)
                            <option value="{{ $key }}" @if($key == $model->experiance_range) {{ 'selected' }} @endif>{{ $experiance }}</option>
                        @endforeach
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="input-group">
                  <input id="number_of_employees" name="number_of_employees" class="form-control @error('number_of_employees') is-invalid @enderror" type="number" value="{{ $model->number_of_employees }}">
                </div>
                ...
                <div class="col-md-4">
                    <label for="date" class="col-form-label">Start Date</label>
                      <div class="input-group date" id="start_date_div">
                        <input type="date" class="form-control" id="start_date" name="start_date" value="{{ Carbon\Carbon::parse($model->start_date)->format('Y-m-d') }}" />
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="input-group date" id="end_date_div">
                        <input type="date" class="form-control" id="end_date" name="end_date" value="{{ Carbon\Carbon::parse($model->end_date)->format('Y-m-d') }}" />
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="input-group">
                                    <input id="minimum_price" name="minimum_price" class="form-control @error('minimum_price') is-invalid @enderror" type="number" value="{{ $model->minimum_price }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input id="maximum_price" name="maximum_price" class="form-control @error('maximum_price') is-invalid @enderror" type="number" value="{{  $model->maximum_price }}">
                                    <span class="input-group-text">$</span>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="note" name="note" rows="6\4" value="{{  $model->note }}"></textarea>
                </div>
            </div>
            <div class="mt-5">
